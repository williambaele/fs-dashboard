...
const GroupTaskFormModalEdit = ({ onClose, isTaskFormVisible, user, groupTask }) => {
    ...
    const [startDate, setStartDate] = useState(groupTask.startDate);
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const response = await fetch(`/api/grouptasks/${groupTask._id}`, {
          method: "PATCH",
...
export default GroupTaskFormModalEdit;