...
const UserPostCard = () => {
  return (
    <div className="md:grid-cols-3 grid shadow-sm h-1/2 rounded-xl">
      ...
      <div className="col-span-2 p-4 bg-gray-100 rounded-r-xl space-y-5 relative">
        ...
        <div className="flex gap-4 w-full">
          ...
          <div className="absolute top-2 right-2 p-2 flex gap-2 rounded-xl bg-white">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
              fill="currentColor"
              class="bi bi-pencil-square cursor-pointer hover:text-blue-400"
              viewBox="0 0 16 16"
            >
