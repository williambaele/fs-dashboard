...
const Sidebar = ({ activeMenu, setActiveMenu }) => {
  ...
  return (
    <>
      <div className="flex items-center justify-between w-full h-14 p-2 px-4 bg-[#232323] md:hidden">
        <span className="flex-none text-xl font-semibold text-white" href="/">
      ...
      {dropdownVisibility && (
        <div className="bg-[#232323] h-full w-full px-4 border-t py-2 md:hidden">
      ...
      <div className="hidden md:block h-screen bg-[#0b0b0b] text-white sticky top-0 left-0 bottom-0 z-[60] w-64 border-r border-gray-700 pt-7 pb-10 ">
        ...
        <nav className="flex flex-col flex-wrap justify-between w-full h-full p-6">
          <ul className="space-y-1.5 ">
            ...
            <li onClick={() => setActiveMenu("group")}>
              <div
                className={`flex items-center gap-x-3.5 py-2 px-2.5  text-sm text-gray-100 rounded-md cursor-pointer ${
                  activeMenu === "group"
                    ? "bg-[#593EFE] font-bold"
