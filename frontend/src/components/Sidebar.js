...
const Sidebar = ({ activeMenu, setActiveMenu }) => {
  ...
  return (
    <div class="h-screen bg-[#0b0b0b] text-white top-0 left-0 bottom-0 z-[60] w-64 border-r border-gray-700 pt-7 pb-10  scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0">
      <div class="px-6">
