            ...
            >
              <ul class="pl-3 pt-2">
                <li class="hs-accordion" id="users-accordion-sub-1">
                  <div class="flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800  dark:hs-accordion-active:text-white">
                    Sub Menu 1
                    <svg
                ...
                <li class="hs-accordion" id="users-accordion-sub-2">
                  <div class="flex items-center gap-x-3.5 py-2 px-2.5  text-sm text-slate-700 rounded-md hover:bg-gray-100">
                    Sub Menu 2
                    <svg
                      class="hs-accordion-active:block ml-auto hidden w-3 h-3 text-gray-600 group-hover:text-gray-500"
                      width="16"
